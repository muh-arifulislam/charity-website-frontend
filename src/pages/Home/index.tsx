...
import heroBgImg from "../../assets/images/heroBg-home.png";
...
const Home = () => {
  return (
    <div className="">
      ...
      <section
        className="py-[135px] relative z-0  w-full bg-cover bg-center bg-no-repeat  before:content-[''] before:absolute before:left-0 before:top-0 before:w-full before:h-full before:bg-overlay-accent before:-z-10 before:backdrop-blur-sm"
        style={{ backgroundImage: `url(${heroBgImg})` }}
      >
        <div className="max-w-screen-xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-[56px] relative">
            <div className="text-white">
              <p className="text-[35px] sue-ellen-francisco-regular leading-[108%]mb-[30px]">
                How We Help
              </p>
              <p className="text-[40px] shippori-mincho-extrabold leading-[120%] mb-[30px]">
                Join The CommunityTo Give Education For Children
              </p>
              <p className="text-xl leading-[130%] mb-[30px] text-slate-300">
            ...
            <div className="border px-5 sm:px-[63px] py-[48px]">
              <h4 className="text-center text-2xl sm:text-[35px] shippori-mincho-extrabold leading-[120%] mb-[30px] text-white">
                Become A Volunteer
              </h4>
              <form action="">
                <div className="w-full mb-[30px]">
                  <input
                    className="w-full border bg-transparent p-[24px] outline-none text-white text-lg"
                    type="text"
                ...
                <div className="w-full mb-[30px] h-auto">
                  <textarea
                    className="w-full border bg-transparent p-[24px] outline-none text-white text-lg"
                    placeholder="Message*"
                  ></textarea>
                ...
                <div>
                  <Button variant="white" type="submit" className="px-8">
                    Submit Now
                  </Button>
                </div>
              </form>
